defmodule OssregistryWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OssregistryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OssregistryWeb.Gettext, "errors", msg, opts)
    end
  end
